...
let(:streamer) { ElevatorMedia::Streamer.new }                                                                             
  ...
  context "testing the getTime method" do
    ...
    it "RestClient should be called with the time service url" do
      ...
      expect(RestClient).to receive(:get).with("http://worldtimeapi.org/api/timezone/America/Toronto") {fake_rest_client_response}
    ...
    it "We should handle service response correctly" do
      ...
      expect(RestClient).to receive(:get).with("http://worldtimeapi.org/api/timezone/America/Toronto").and_return(fake_rest_client_response)
